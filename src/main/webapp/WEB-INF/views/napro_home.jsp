...
<body style="margin:5px;">
    <div class="container-fluid">
        ...
        <div class="row">
            <a href="/napro/registration">Move to Napro registration page.</a>
        </div>
    </div>

    <script type="text/javascript" src="/resources/lib/jquery-3.2.0.min.js"></script>
    <script type="text/javascript" src="/resources/js/napro_home.js"></script>
</body>
</html>